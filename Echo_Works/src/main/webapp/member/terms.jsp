...
<head>
  ...
  <style>
    ...
    .btn-cancel:hover {
      ...
      background-color: #6c757d; /* 배경색 유지 */
      border-color: #6c757d; /* 테두리색 유지 */
    ...
    .form-check-input:focus {
      box-shadow: 0 0 0 0.25em rgba(0, 0, 0, 0.25); /* 검정색 포커스 */
      border-color: #000000; /* 검정색 테두리 */
    }
    .required-label {
      color: red;
    ...
    <div class="row">
      <div class="col-12">
        <div class="form-check mb-3">
          ...
          <label class="form-check-label" for="agreeAll">이용약관, 개인정보 수집 및 이용에 모두 동의합니다.</label>
        </div>
      </div>
      <div class="col-12">
        <div class="form-check mb-3">
          <input class="form-check-input" type="checkbox" value="" id="agreeTerms" name="agreeTerms">
          <label class="form-check-label" for="agreeTerms">이용약관 동의 <span class="required-label">(필수)</span></label>
        </div>
        <div class="terms-box">
          <!-- 이용약관 내용 -->
          제1조 목적<br /><br />
          본 이용약관은 “에코웍스”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.<br /><br />
          제2조 용어의 정의<br /><br />
          ...
          이 약관은 <2022년 1월27일>부터 시행합니다.<br />
        </div>
      </div>
      <div class="col-12">
        <div class="form-check mb-3">
          <input class="form-check-input" type="checkbox" value="" id="agreePrivacy" name="agreePrivacy">
          <label class="form-check-label" for="agreePrivacy">개인정보 수집 및 이용 동의 <span class="required-label">(필수)</span></label>
        </div>
        <div class="terms-box">
          <!-- 개인정보 수집 및 이용 동의 내용 -->
          ...
          <strong>회원탈퇴 시까지</strong> (단, 관계 법령에 보존 근거가 있는 경우 해당 기간 시까지 보유, 개인정보처리방침에서 확인 가능)<br />
        </div>
      </div>
      <div class="col-12">
        <div class="form-check mb-3">
          <input class="form-check-input" type="checkbox" value="" id="agreeMarketing" name="agreeMarketing">
          <label class="form-check-label" for="agreeMarketing">마케팅 활용 동의 및 광고 수신 동의<span class="required-label"></span></label>
        </div>
        <div class="terms-box">
        ...
        <div class="col-12">
          <div class="form-check mb-3">
            <input class="form-check-input" type="checkbox" value="" id="agreeSms" name="agreeSms">
            <label class="form-check-label" for="agreeSms">SMS 수신 동의(선택)<span class="required-label"></span></label>
          </div>
          <div class="col-12">
            <div class="form-check mb-3">
              <input class="form-check-input" type="checkbox" value="" id="agreeEmail" name="agreeEmail">
              <label class="form-check-label" for="agreeEmail">E-Mail 수신 동의(선택)<span class="required-label"></span></label>
            </div>
          </div>
          <div class="col-12 buttons">
            <button type="button" class="btn btn-cancel btn-lg">취소</button>
            <button type="button" class="btn btn-submit btn-lg" id="submitBtn">가입하기</button>
          </div>
        </div>
      </div>
    </div>
